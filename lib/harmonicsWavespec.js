...
function HarmonicsWavespec(partialWeightsAndPhases) {
  this.partialWeightsAndPhases = partialWeightsAndPhases;
}

HarmonicsWavespec.prototype.sampleAtTime = function(sampleTime) {
  var totalWeights = 0;
  ...
  return totalWeights === 0 ? 0 : sample / totalWeights;
};

HarmonicsWavespec.fromString = function(specString) {
  ...
  return new HarmonicsWavespec(partialWeightsAndPhases);
};

module.exports = HarmonicsWavespec;